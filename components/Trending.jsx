...
function Trending({ result }) {
  return (
    <div className="hover:bg-white hover:bg-opacity-[0.04] px-4 py-2 cursor-pointer transition duration-200 ease-out flex items-center justify-between rounded-md">
