...
function Widgets({ trendingResults, followResults }) {
  return (
    <div className="hidden lg:inline ml-8 xl:w-[450px] sm:w-[300px] py-1 space-y-5">
      ...
      <div className="text-[#d9d9d9] space-y-3 bg-[#15181c] pt-2 rounded-xl w-11/12 xl:w-9/12">
        ...
        <button className="hoverAnimation font-light w-full text-blue-500 rounded-md text-left">
          Show more
        </button>
      </div>
      ...
      <div className="text-[#d9d9d9] space-y-3 bg-[#15181c] pt-2 rounded-xl w-11/12 xl:w-9/12">
        ...
        {followResults.map((result, index) => (
          ...
          >
            ...
            <button className=" bg-white text-black rounded-full font-bold text-sm py-1.5 px-3.5">
              Follow
            </button>
          </div>
        ))}
